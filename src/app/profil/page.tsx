...
import { MapPin, Users, Maximize, History, Target, Compass, ExternalLink } from "lucide-react"
...
export const metadata = {
  ...
  description:
    "Sejarah, visi misi, dan data ringkas Desa Sedayu, Kecamatan Jumantono, Kabupaten Karanganyar.",
}
          ...
          <section className="grid gap-4 sm:grid-cols-3">
            ...
            <div className="rounded-2xl border border-border bg-card p-6">
              ...
              <p className="font-serif text-2xl text-foreground">
                {p.jumlah_penduduk != null
                  ? Number(p.jumlah_penduduk).toLocaleString("id-ID") + " jiwa"
                  : "-"}
              </p>
            </div>
            <div className="rounded-2xl border border-border bg-card p-6">
